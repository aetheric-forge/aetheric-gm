...
var campaignEntityRepository = new SqliteCampaignEntityRepository(databaseConnectionString);
await campaignEntityRepository.InitializeAsync();
builder.Services.AddSingleton<ICampaignEntityRepository>(campaignEntityRepository);
